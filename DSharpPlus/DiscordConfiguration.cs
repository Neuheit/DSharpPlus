...
namespace DSharpPlus
{
    ...
    public sealed class DiscordConfiguration
    {
        ...
        /// <summary>
        /// Whether the client should receive guild subscription events.
        /// <para>Defaults to true.</para>
        /// </summary>
        public bool GuildSubscrptions { internal get; set; } = true;
        ...
        public DiscordConfiguration(DiscordConfiguration other)
        {
            ...
            this.GuildSubscrptions = other.GuildSubscrptions;
        }
    }
}
